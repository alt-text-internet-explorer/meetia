...
const collections = [
  ...
  { id: 2, title: "Media", src: "/file.svg", alt: "Collection 1", subtitle: "Genre", summary: "second summary"},
  { id: 3, title: "Media", src: "/file.svg", alt: "Collection 1", subtitle: "Genre", summary: "yet another summary1."},
  { id: 4, title: "Media", src: "/file.svg", alt: "Collection 1", subtitle: "Genre", summary: "yet another summary2."},
  { id: 5, title: "Media", src: "/file.svg", alt: "Collection 1", subtitle: "Genre", summary: "yet another summary3."},
]
...
export default function Page({ id }) {
  return (
    ...
    <div className="container py-4">
      <div className="card card border-0 shadow-sm overflow-hidden p-3" style={{ height: "200px"}}>
