...
const collectionsList = [
  {
    ...
    items: [
    { id: 0, title: "Lorem ipsum Review", src: "/file.svg", alt: "Collection 1", subtitle: "No", summary: "Nothing here"},
    ]
  },
  {
    id: 1,
    ...
    items: [
    { id: 1, title: "Lorem ipsum Review", src: "/file.svg", alt: "Collection 1", subtitle: "5 stars Lorem ipsum!", summary: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi tincidunt sapien sem, sit amet convallis sapien consequat quis. Suspendisse aliquet pulvinar urna eu congue. Suspendisse orci magna, aliquam ut vestibulum eget, pellentesque ac leo. Sed dignissim risus sit amet lorem malesuada congue. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi tincidunt sapien sem, sit amet convallis sapien consequat quis. Suspendisse aliquet pulvinar urna eu congue. Suspendisse orci magna, aliquam ut vestibulum eget, pellentesque ac leo. Sed dignissim risus sit amet lorem malesuada congue. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi tincidunt sapien sem, sit amet convallis sapien consequat quis. Suspendisse aliquet pulvinar urna eu congue. Suspendisse orci magna, aliquam ut vestibulum eget, pellentesque ac leo. Sed dignissim risus sit amet lorem malesuada congue. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi tincidunt sapien sem, sit amet convallis sapien consequat quis. Suspendisse aliquet pulvinar urna eu congue. Suspendisse orci magna, aliquam ut vestibulum eget, pellentesque ac leo. Sed dignissim risus sit amet lorem malesuada congue. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi tincidunt sapien sem, sit amet convallis sapien consequat quis. Suspendisse aliquet pulvinar urna eu congue. Suspendisse orci magna, aliquam ut vestibulum eget, pellentesque ac leo. Sed dignissim risus sit amet lorem malesuada congue. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi tincidunt sapien sem, sit amet convallis sapien consequat quis. Suspendisse aliquet pulvinar urna eu congue. Suspendisse orci magna, aliquam ut vestibulum eget, pellentesque ac leo. Sed dignissim risus sit amet lorem malesuada congue. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi tincidunt sapien sem, sit amet convallis sapien consequat quis. Suspendisse aliquet pulvinar urna eu congue. Suspendisse orci magna, aliquam ut vestibulum eget, pellentesque ac leo. Sed dignissim risus sit amet lorem malesuada congue."},
    { id: 2, title: "Title!", src: "/file.svg", alt: "Collection 1", subtitle: "Genre", summary: "General layout of the layout page"},
    { id: 3, title: "Nothing", src: "/file.svg", alt: "Collection 1", subtitle: "Genre", summary: "Nothing here."},
    { id: 4, title: "Lorem ipsum text", src: "/file.svg", alt: "Collection 1", subtitle: "Genre", summary: "no review components"}
    ]
  }
];
...
export default function Page({ id }) {
  ...
  return (
    ...
    <div className="container py-4">
      <div className="card border-0 shadow-sm overflow-hidden p-3" style={{ height: "200px"}}>
      ...
      <div className="row row-cols-1 g-4">
        {collection.items.map((item) => (
          <div className="col" key={item.id}>
            ...
            <div className="card shadow-sm rounded-2 overflow-hidden h-100" style={{ maxHeight: "200px"}}>
              ...
              <div className="card-group h-100">
                ...
                <div className="card border-0 px-1">
                  <div className="card-body overflow-y-auto" style={{ height: "150px" }}>
                    ...
                    <h6 className="card-subtitle text-muted small mb-2">{item.subtitle}</h6>
                    <p className="card-text text-secondary" style={{ fontSize: "0.8rem"}}>
                      {item.summary}
                    </p>
                  </div>
