...
const collections = [
  ...
  { id: 1, title: "Lorem Ipsum", subtitle: "by Lorem", rating: "★★★★★", reviewTitle: "Book review!", reviewSubtitle: "Format: Hardcover", reviewRating: "★★★★☆", src: "/file.svg", alt: "Collection 1",
  ...
  { id: 2, title: "Title", subtitle: "Subtitle", rating: "★★★★★", reviewTitle: "Review title", reviewSubtitle: "Subtitle", reviewRating: "★★★★★", reviewDescription: "Nothing here..." },
...
export default function Page({ id }) {
  ...
  return (
    ...
    <div className="container py-4">
      <div className="card border-0 overflow-hidden p-3" style={{ height: "250px"}}>
        ...
        <div className="overflow-y-auto h-100 pe-2">
          ...
          <p className="fs-5 mb-1" style={{ color: "#e87400" }}>{media.rating}</p>
          <p className="text-dark-emphasis" style={{ fontSize: "0.8rem"}}>{media.description}</p>
        </div>
              ...
              <div className="card-group h-100">
                ...
                <div className="card border-0 px-1">
                  <div className="card-body overflow-y-auto">
                    <h4 className="card-title h5 fs-5 mb-1" style={{ color: "#e87400" }}>{media.reviewRating} <span style={{ color: "#333333"}}>{media.reviewTitle}</span></h4>
                    <h6 className="card-subtitle text-muted small mb-2">{media.reviewSubtitle}</h6>
                    <p className="card-text text-dark-emphasis" style={{ fontSize: "0.8rem"}}>{media.reviewDescription}</p>
                  </div>
                </div>
